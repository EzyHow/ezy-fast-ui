            ...
            <div className="p-8 md:p-12 lg:px-16 lg:py-24">
                <div className="mx-auto max-w-lg text-center">
                    <h2 className="text-2xl font-bold text-white md:text-3xl">
                        Ezy Fast UI Code Snippets & Components
                    </h2>

                    <p className="text-gray-400 sm:mt-4 sm:block">
                        This website contains collection of CSS code snippets and components which helps developers
                        to complete their task quickly. And the happy part is, these code snippets and components
                        are free for both personal and commercial use.
                    </p>
                    <p className="text-gray-200 sm:mt-4 sm:block animate-pulse">Made by Developer, for Developers.</p>
                    <p className="text-gray-400 sm:mt-4 sm:block">Follow me on:</p>
			...
			<form action="#" className="sm:flex sm:gap-4">
				<div className="sm:flex-1">
					...
					<input
						...
						className="w-full rounded-md p-3 shadow-sm transition focus:border-white focus:outline-none focus:ring focus:ring-yellow-400 border-gray-700 bg-gray-800 text-white"
					/>
				</div>
